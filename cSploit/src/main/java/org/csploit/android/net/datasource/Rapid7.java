...
class Rapid7 {
    ...
    private static class ExploitReceiver implements RemoteReader.Receiver {
        ...
        public static MsfExploit parsePage(String html) {
            ...
            return new MsfExploit(name, summary, description, ranking, targets, authors,
                    platforms, architectures, references);
        }

        public static void beginFetchReferences(RemoteReader.Job job, Target.Exploit exploit,
                                                Search.Receiver<Target.Exploit> receiver) {
