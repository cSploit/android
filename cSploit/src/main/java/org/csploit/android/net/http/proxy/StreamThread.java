...
public class StreamThread implements Runnable {
    ...
    public void run() {
        ...
        try {
            max = Integer.parseInt(System.getSettings()
                    .getString("PREF_HTTP_MAX_BUFFER_SIZE", "10485760"));
        ...
        try {
            ...
            while ((read = mReader.read(chunk, 0, CHUNK_SIZE)) > 0 && size < max) {
                ...
                location = location == null ?
                        RequestParser.getHeaderValue(RequestParser.LOCATION_HEADER, mBuffer) : location;
                contentType = contentType == null ?
                        RequestParser.getHeaderValue(RequestParser.CONTENT_TYPE_HEADER, mBuffer) : contentType;
            ...
            if (!mBuffer.isEmpty()) {
                ...
                if (location != null && location.startsWith("https://") &&
                    ...
                    HTTPSMonitor.getInstance().addURL(mClient,
