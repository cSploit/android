...
public class ChildManager {
     ...
     */
    public static int exec(String handler, String cmd, String[] env, EventReceiver receiver)
            throws InterruptedException, ChildDiedException, ChildNotStartedException {
        return wait(async(handler, cmd, env, receiver));
    }

    public static int exec(String handler, String cmd)
            throws InterruptedException, ChildDiedException, ChildNotStartedException {
     ...
     */
    public static Child async(String handler, String cmd, String[] env, EventReceiver receiver)
            throws ChildNotStartedException {
        Child c;
    ...
    public static void onEvent(final int childID, final Event event) {
        ...
        eventExecutor.execute(() -> dispatchEvent(fc, event));
    }

    public static class ChildDiedException extends Exception {
        public ChildDiedException(int signal) {
