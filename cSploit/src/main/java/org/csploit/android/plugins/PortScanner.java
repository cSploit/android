...
public class PortScanner extends Plugin {
    ...
    private void setStoppedState() {
        ...
        mRunning = false;
        mScanFloatingActionButton
                .setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_play_arrow_24dp));
    ...
    private void setStartedState() {
        ...
        try {
            ...
            Toast.makeText(PortScanner.this,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTextDoc = findViewById(R.id.scanDoc);
        mTextParameters = findViewById(R.id.scanParameters);
        mScanFloatingActionButton = findViewById(R.id.scanToggleButton);
        mScanProgress = findViewById(R.id.scanActivity);
        ...
        mScanFloatingActionButton.setOnClickListener(v -> {
            if (mRunning) {
                setStoppedState();
            } else {
                setStartedState();
        ...
        ListView mScanList = findViewById(R.id.scanListView);
        ...
        mScanList.setOnItemLongClickListener((parent, view, position, id) -> {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.select_ports:
                ...
                new InputDialog(getString(R.string.select_ports),
                        getString(R.string.enter_ports_list), this, input -> {
                    input = input.trim();
    ...
    private class Receiver extends NMap.SynScanReceiver {
        ...
        public void onStart(String commandLine) {
            ...
            PortScanner.this.runOnUiThread(() -> {
                mRunning = true;
        ...
        public void onEnd(int exitCode) {
            ...
            PortScanner.this.runOnUiThread(PortScanner.this::setStoppedState);
        }
