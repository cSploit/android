...
public class Hijacker extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHijackToggleButton = findViewById(R.id.hijackToggleButton);
        mHijackProgress = findViewById(R.id.hijackActivity);
        ...
        mListView.setOnItemLongClickListener((parent, view, position, id) -> {
            ...
            if (session != null) {
                new InputDialog(getString(R.string.save_session),
                        ...
                        .getFileName(), true, false, Hijacker.this, name -> {
                    if (!name.isEmpty()) {
                        try {
        ...
        mHijackToggleButton.setOnClickListener(v -> {
            if (mRunning) {
                setStoppedState();
            } else {
                setStartedState();
