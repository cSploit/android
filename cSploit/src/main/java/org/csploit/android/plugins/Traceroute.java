...
public class Traceroute extends Plugin {
    ...
    private void setStoppedState() {
        ...
        mRunning = false;
        mTraceFloatingActionButton.setImageDrawable(
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTraceFloatingActionButton = findViewById(R.id.traceToggleButton);
        mTraceProgress = findViewById(R.id.traceActivity);

        mTraceFloatingActionButton.setOnClickListener(v -> {
            if (mRunning) {
                setStoppedState();
            } else {
                setStartedState();
        ...
        ListView mTraceList = findViewById(R.id.traceListView);
    ...
    private class Receiver extends NMap.TraceReceiver {
        ...
        public void onEnd(int exitCode) {
            ...
            Traceroute.this.runOnUiThread(Traceroute.this::setStoppedState);
        }
