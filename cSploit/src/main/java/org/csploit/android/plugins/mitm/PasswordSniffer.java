...
public class PasswordSniffer extends AppCompatActivity {
        ...
        switch (item.getItemId()) {
            case R.id.action_fields:
                if (!mSniffToggleButton.isEnabled())
                    Toast.makeText(this,
                            "The changes won't take effect until you stop the current traffic sniffing",
    ...
    private void setStartedState() {
        try {
            ...
            FileWriter mFileWriter = new FileWriter(mFileOutput, true);
        ...
        try {
            mSpoofSession.start(new OnAccountListener() {
                ...
                public void onAccount(final String protocol, final String address,
                    ...
                    PasswordSniffer.this.runOnUiThread(() -> {
                ...
                public void onEnd(final int exitValue) {
                    PasswordSniffer.this.runOnUiThread(() -> {
                        if (exitValue != 0) {
                            Toast.makeText(PasswordSniffer.this, "ettercap returned #" +
                ...
                public void onDeath(final int signal) {
                    PasswordSniffer.this.runOnUiThread(() -> {
                        Toast.makeText(PasswordSniffer.this, "ettercap killed by signal #" +
            ...
            System.errorLogging(e);
            mSniffToggleButton.setChecked(false);
            Toast.makeText(PasswordSniffer.this, getString(R.string.child_not_started),
                    Toast.LENGTH_LONG).show();
        }
    }
    ...
    public class ListViewAdapter extends BaseExpandableListAdapter {
        ...
        public void addGroup(String name) {
            mGroups.put(name, new ArrayList<>());
