...
public class PacketForger extends Plugin implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mProtocol = findViewById(R.id.protocolSpinner);
        mPort = findViewById(R.id.portText);
        mWaitResponse = findViewById(R.id.responseCheckBox);
        mData = findViewById(R.id.dataText);
        mResponse = findViewById(R.id.responseText);
        mSendButton = findViewById(R.id.sendButton);
        Button mSendWOL = findViewById(R.id.sendWOL);

        if (System.getCurrentTarget().getType() != Type.ENDPOINT)
            mSendWOL.setVisibility(View.INVISIBLE);

        mProtocol.setAdapter(new ArrayAdapter<>(this,
        ...
        if (!mRunning) {
            if (v.getId() == R.id.sendButton) {
                ...
                mThread = new Thread(() -> {
                        ...
                        try {
                            if (protocol == TCP_PROTOCOL) {
                                ...
                                if (waitResponse) {
                                    ...
                                    PacketForger.this
                                            .runOnUiThread(() -> mResponse.setText(text));
                    ...
                    PacketForger.this.runOnUiThread(() -> {
    ...
    private void setStoppedState(String errorMessage) {
        ...
        if (errorMessage != null && !isFinishing())
            new ErrorDialog(getString(R.string.error), errorMessage, this).show();
    }
