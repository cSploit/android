...
public class Inspector extends Plugin {
    ...
    private void updateView() {
        if (ThreadHelper.isOnMainThread()) {
            ...
            runOnUiThread(this::write_services);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStartButton = findViewById(R.id.inspectToggleButton);
        mActivity = findViewById(R.id.inspectActivity);
        TextView mDeviceName = findViewById(R.id.deviceName);
        mDeviceType = findViewById(R.id.deviceType);
        mDeviceOS = findViewById(R.id.deviceOS);
        mDeviceServices = findViewById(R.id.deviceServices);
    ...
    private class Receiver extends InspectionReceiver {
        ...
        public void onOsFound(final String os) {
            ...
            Inspector.this.runOnUiThread(() -> mDeviceOS.setText(os));
        }
        ...
        public void onDeviceFound(final String device) {
            ...
            Inspector.this.runOnUiThread(() -> mDeviceType.setText(device));
        }

        @Override
        public void onEnd(int code) {
            Inspector.this.runOnUiThread(() -> {
                if (mRunning)
                    setStoppedState();
            });
        }
