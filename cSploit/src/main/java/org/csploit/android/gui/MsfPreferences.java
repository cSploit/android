...
public class MsfPreferences extends PreferenceActivity {
            ...
            switch (opt.getType()) {
                ...
                case ADDRESS:
                    if (Patterns.IP_ADDRESS.matcher((String) newValue).matches()) {
                        ...
                        Toast.makeText(getApplicationContext(), getString(
                                R.string.error_invalid_address_or_port), Toast.LENGTH_LONG).show();
                    break;
                case INTEGER:
                    try {
                        ...
                        Toast.makeText(getApplicationContext(), getString(
                                R.string.pref_err_invalid_number), Toast.LENGTH_SHORT).show();
                    }
                    break;
                case BOOLEAN:
                    if ((Boolean) newValue)
                ...
                case PORT:
                    try {
                        ...
                        Toast.makeText(getApplicationContext(), getString(
                                R.string.invalid_port), Toast.LENGTH_SHORT).show();
                    }
                    break;
            }
            return false;
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        ArrayList<Preference> required = new ArrayList<>();
        ArrayList<Preference> general = new ArrayList<>();
        ArrayList<Preference> advanced = new ArrayList<>();
        ArrayList<Preference> evasion = new ArrayList<>();
