...
int init_csploit_events_cache(JNIEnv *env) {
  struct class_and_ctor_signature {
    ...
    { "org/csploit/android/events/Port", "(SLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V" },
    { "org/csploit/android/events/Os", "(BLjava/lang/String;Ljava/lang/String;)V" },
    ...
    { "org/csploit/android/events/Login", "(SLjava/net/InetAddress;Ljava/lang/String;Ljava/lang/String;)V" },
    { "org/csploit/android/events/Attempts", "(IIIII)V" },
