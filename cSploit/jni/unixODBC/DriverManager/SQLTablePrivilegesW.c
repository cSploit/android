 ...
 **********************************************************************
 *
 * $Id: SQLTablePrivilegesW.c,v 1.10 2009/02/18 17:59:08 lurcher Exp $
 *
 * $Log: SQLTablePrivilegesW.c,v $
 * Revision 1.10  2009/02/18 17:59:08  lurcher
 * Shift to using config.h, the compile lines were making it hard to spot warnings
 *
 * Revision 1.9  2008/08/29 08:01:39  lurcher
 * Alter the way W functions are passed to the driver
 *
 * Revision 1.8  2007/02/28 15:37:49  lurcher
 ...
 *
 * Revision 1.7  2004/01/12 09:54:39  lurcher
 *
...
\n\t\t\tTable Name = %s", 
    ...
    if ( statement -> connection -> unicode_driver ||
		    CHECK_SQLTABLEPRIVILEGESW( statement -> connection ))
    {
