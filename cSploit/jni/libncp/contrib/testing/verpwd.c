/*
    verpwd.c - NWDSVerifyObjectPassword() API demo
	...
	1.01  2001, February 23		Petr Vandrovec <vandrove@vc.cvut.cz>
		Added '-r' option. Requested by Patrick Pollet.
...
help(void)
{
	...
	printf(_("\n"
	       ...
	       "-P password     Password (default TEST)\n"
	       "-r              Use raw password without uppercasing\n"
	       "\n"));
}
