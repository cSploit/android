/*
    rmclass.c - NWDSRemoveClassDef() API demo
...
help(void)
{
	...
	printf(_("\n"
	       ...
	       "-o class_name   Name of class (default Top)\n"
...
int main(int argc, char *argv[]) {
	...
	dserr = NWDSRemoveClassDef(ctx, objectname);
	if (dserr) {
		fprintf(stderr, "RemoveClassDef failed with %s\n", 
			strnwerror(dserr));
	} else {
		printf("RemoveClassDef suceeded\n");
	}
	NWCCCloseConn(conn);
