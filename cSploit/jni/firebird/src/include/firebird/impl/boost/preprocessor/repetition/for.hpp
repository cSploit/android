...
# endif
#
# define FB_BOOST_PP_FOR FB_BOOST_PP_CAT(FB_BOOST_PP_FOR_, FB_BOOST_PP_AUTO_REC(FB_BOOST_PP_FOR_P, 256))
#
# define FB_BOOST_PP_FOR_P(n) FB_BOOST_PP_CAT(FB_BOOST_PP_FOR_CHECK_, FB_BOOST_PP_FOR_ ## n(1, FB_BOOST_PP_FOR_SR_P, FB_BOOST_PP_FOR_SR_O, FB_BOOST_PP_FOR_SR_M))
#
