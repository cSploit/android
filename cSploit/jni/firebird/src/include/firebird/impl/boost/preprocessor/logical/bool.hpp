...
#
# ifndef FB_BOOST_PREPROCESSOR_LOGICAL_BOOL_HPP
# define FB_BOOST_PREPROCESSOR_LOGICAL_BOOL_HPP
#
...
#    define FB_BOOST_PP_BOOL(x) FB_BOOST_PP_BOOL_I(x)
# else
#    define FB_BOOST_PP_BOOL(x) FB_BOOST_PP_BOOL_OO((x))
#    define FB_BOOST_PP_BOOL_OO(par) FB_BOOST_PP_BOOL_I ## par
# endif
#
