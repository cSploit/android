...
C     database parameter block stuff 
     ...
     +     GDS__DPB_ENCRYPT_KEY, GDS__DPB_ACTIVATE_SHADOW, GDS__DPB_SWEEP_INTERVAL,
     +     GDS__DPB_DELETE_SHADOW, GDS__DPB_FORCE_WRITE, GDS__DPB_BEGIN_LOG, 
     +     GDS__DPB_QUIT_LOG, GDS__DPB_NO_RESERVE, GDS__DPB_USER_NAME,
     +     GDS__DPB_PASSWORD, GDS__DPB_PASSWORD_ENC, GDS__DPB_SYS_USER_NAME_ENC,
     +     GDS__DPB_INTERP, GDS__DPB_ONLINE_DUMP, GDS__DPB_OLD_FILE_SIZE,
     +     GDS__DPB_OLD_NUM_FILES, GDS__DPB_OLD_FILE, GDS__DPB_OLD_START_PAGE,
     +     GDS__DPB_OLD_START_SEQNO, GDS__DPB_OLD_START_FILE, GDS__DPB_DROP_WALFILE,
     +     GDS__DPB_OLD_DUMP_ID, GDS__DPB_WAL_BACKUP_DIR, GDS__DPB_WAL_CHKPTLEN

      CHARACTER*1
     +     GDS__DPB_WAL_NUMBUFS, GDS__DPB_WAL_BUFSIZE, GDS__DPB_WAL_GRP_CMT_WAIT,
     +     GDS__DPB_LC_MESSAGES, GDS__DPB_LC_CTYPE, GDS__DPB_CACHE_MANAGER,
     +     GDS__DPB_SHUTDOWN, GDS__DPB_ONLINE, GDS__DPB_SHUTDOWN_DELAY,
     +     GDS__DPB_RESERVED, GDS__DPB_OVERWRITE, GDS__DPB_SEC_ATTACH,
     +     GDS__DPB_DISABLE_WAL

      PARAMETER (
     +     GDS__DPB_VERSION1              = CHAR (1),
     +     GDS__DPB_CDD_PATHNAME          = CHAR (1),
     +     GDS__DPB_ALLOCATION            = CHAR (2), 
     +     GDS__DPB_JOURNAL               = CHAR (3),
     +     GDS__DPB_PAGE_SIZE             = CHAR (4),
     +     GDS__DPB_BUFFERS               = CHAR (5),
     +     GDS__DPB_BUFFER_LENGTH         = CHAR (6),
     +     GDS__DPB_DEBUG                 = CHAR (7),
     +     GDS__DPB_GARBAGE_COLLECT       = CHAR (8),
     ...
     +     GDS__DPB_DBKEY_SCOPE           = CHAR (13),
     +     GDS__DPB_NUMBER_OF_USERS       = CHAR (14), 
     +     GDS__DPB_TRACE                 = CHAR (15),
     +     GDS__DPB_NO_GARBAGE_COLLECT    = CHAR (16), 
     +     GDS__DPB_DAMAGED               = CHAR (17),
