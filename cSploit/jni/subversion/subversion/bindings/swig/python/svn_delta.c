...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"svn_txdelta_op_t_offset_get", _wrap_svn_txdelta_op_t_offset_get, METH_VARARGS, (char *)"svn_txdelta_op_t_offset_get(svn_txdelta_op_t self) -> apr_size_t"},
	 { (char *)"svn_txdelta_op_t_length_set", _wrap_svn_txdelta_op_t_length_set, METH_VARARGS, (char *)"svn_txdelta_op_t_length_set(svn_txdelta_op_t self, apr_size_t length)"},
	 { (char *)"svn_txdelta_op_t_length_get", _wrap_svn_txdelta_op_t_length_get, METH_VARARGS, (char *)"svn_txdelta_op_t_length_get(svn_txdelta_op_t self) -> apr_size_t"},
	 { (char *)"new_svn_txdelta_op_t", _wrap_new_svn_txdelta_op_t, METH_VARARGS, (char *)"new_svn_txdelta_op_t() -> svn_txdelta_op_t"},
	 { (char *)"delete_svn_txdelta_op_t", _wrap_delete_svn_txdelta_op_t, METH_VARARGS, (char *)"delete_svn_txdelta_op_t(svn_txdelta_op_t self)"},
	 { (char *)"svn_txdelta_op_t_swigregister", svn_txdelta_op_t_swigregister, METH_VARARGS, NULL},
	 { (char *)"svn_txdelta_window_t_sview_offset_set", _wrap_svn_txdelta_window_t_sview_offset_set, METH_VARARGS, (char *)"svn_txdelta_window_t_sview_offset_set(svn_txdelta_window_t self, svn_filesize_t sview_offset)"},
	 { (char *)"svn_txdelta_window_t_sview_offset_get", _wrap_svn_txdelta_window_t_sview_offset_get, METH_VARARGS, (char *)"svn_txdelta_window_t_sview_offset_get(svn_txdelta_window_t self) -> svn_filesize_t"},
	 { (char *)"svn_txdelta_window_t_sview_len_set", _wrap_svn_txdelta_window_t_sview_len_set, METH_VARARGS, (char *)"svn_txdelta_window_t_sview_len_set(svn_txdelta_window_t self, apr_size_t sview_len)"},
	 { (char *)"svn_txdelta_window_t_sview_len_get", _wrap_svn_txdelta_window_t_sview_len_get, METH_VARARGS, (char *)"svn_txdelta_window_t_sview_len_get(svn_txdelta_window_t self) -> apr_size_t"},
	 { (char *)"svn_txdelta_window_t_tview_len_set", _wrap_svn_txdelta_window_t_tview_len_set, METH_VARARGS, (char *)"svn_txdelta_window_t_tview_len_set(svn_txdelta_window_t self, apr_size_t tview_len)"},
	 { (char *)"svn_txdelta_window_t_tview_len_get", _wrap_svn_txdelta_window_t_tview_len_get, METH_VARARGS, (char *)"svn_txdelta_window_t_tview_len_get(svn_txdelta_window_t self) -> apr_size_t"},
	 { (char *)"svn_txdelta_window_t_num_ops_set", _wrap_svn_txdelta_window_t_num_ops_set, METH_VARARGS, (char *)"svn_txdelta_window_t_num_ops_set(svn_txdelta_window_t self, int num_ops)"},
