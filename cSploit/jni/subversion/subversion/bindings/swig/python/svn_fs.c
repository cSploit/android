...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"svn_fs_path_change2_t_text_mod_get", _wrap_svn_fs_path_change2_t_text_mod_get, METH_VARARGS, (char *)"svn_fs_path_change2_t_text_mod_get(svn_fs_path_change2_t self) -> svn_boolean_t"},
	 { (char *)"svn_fs_path_change2_t_prop_mod_set", _wrap_svn_fs_path_change2_t_prop_mod_set, METH_VARARGS, (char *)"svn_fs_path_change2_t_prop_mod_set(svn_fs_path_change2_t self, svn_boolean_t prop_mod)"},
	 { (char *)"svn_fs_path_change2_t_prop_mod_get", _wrap_svn_fs_path_change2_t_prop_mod_get, METH_VARARGS, (char *)"svn_fs_path_change2_t_prop_mod_get(svn_fs_path_change2_t self) -> svn_boolean_t"},
	 { (char *)"svn_fs_path_change2_t_node_kind_set", _wrap_svn_fs_path_change2_t_node_kind_set, METH_VARARGS, (char *)"svn_fs_path_change2_t_node_kind_set(svn_fs_path_change2_t self, svn_node_kind_t node_kind)"},
	 { (char *)"svn_fs_path_change2_t_node_kind_get", _wrap_svn_fs_path_change2_t_node_kind_get, METH_VARARGS, (char *)"svn_fs_path_change2_t_node_kind_get(svn_fs_path_change2_t self) -> svn_node_kind_t"},
	 { (char *)"svn_fs_path_change2_t_copyfrom_known_set", _wrap_svn_fs_path_change2_t_copyfrom_known_set, METH_VARARGS, (char *)"svn_fs_path_change2_t_copyfrom_known_set(svn_fs_path_change2_t self, svn_boolean_t copyfrom_known)"},
	 ...
	 { (char *)"svn_fs_path_change_t_text_mod_get", _wrap_svn_fs_path_change_t_text_mod_get, METH_VARARGS, (char *)"svn_fs_path_change_t_text_mod_get(svn_fs_path_change_t self) -> svn_boolean_t"},
