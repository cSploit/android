...
extern "C"
#endif
SWIGEXPORT void Init_diff(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mDiff = rb_define_module("Svn");
  mDiff = rb_define_module_under(mDiff, "Ext");
  mDiff = rb_define_module_under(mDiff, "Diff");
