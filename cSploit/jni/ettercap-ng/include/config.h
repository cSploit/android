...
/* Define to 1 if you have the `mutex_recursive_np' function. */
/* #undef HAVE_MUTEX_RECURSIVE_NP */
...
/* where can I find the ettercap executable ? */
#define INSTALL_BINDIR "/system/bin"

/* where can I find my data file ? */
#define INSTALL_DATADIR "/system/usr/share"

/* the exec_prefix passed by configure */
#define INSTALL_EXECPREFIX "/system/usr"

/* where can I find my plugins ? */
#define INSTALL_LIBDIR "/system/usr/lib"

/* the prefix passed by configure */
#define INSTALL_PREFIX "/system/usr"

/* where can I find my sysconf file ? */
#define INSTALL_SYSCONFDIR "/system/usr/etc"

/* Define if the OS needs help to load dependent libraries for dlopen(). */
/* #undef LTDL_DLOPEN_DEPLIBS */

/* Define to the system default library search path. */
#define LT_DLSEARCH_PATH "/system/lib"
...
/* Define to 1 if want to build library only */
/* #undef JUST_LIBRARY */
