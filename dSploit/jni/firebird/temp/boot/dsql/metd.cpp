...
0,1,0,25,1,0,0,1,24,0,3,0,25,1,1,0,1,21,8,0,1,0,0,0,25,1,2,0,
255,14,1,1,21,8,0,0,0,0,0,25,1,2,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_7 [107] =
   {	// blr string 

4,2,4,1,5,0,41,3,0,32,0,41,3,0,32,0,7,0,7,0,7,0,4,0,1,0,41,3,
0,32,0,12,0,2,7,'C',1,'K',5,0,0,'G',47,24,0,1,0,25,0,0,0,255,
14,1,2,1,24,0,0,0,41,1,0,0,3,0,1,24,0,4,0,41,1,1,0,4,0,1,21,8,
0,1,0,0,0,25,1,2,0,255,14,1,1,21,8,0,0,0,0,0,25,1,2,0,255,255,
76
   };	// end of blr string 
static const UCHAR	jrd_16 [124] =
   {	// blr string 

4,2,4,1,5,0,41,3,0,32,0,41,3,0,32,0,41,3,0,0,1,7,0,7,0,4,0,1,
0,41,3,0,32,0,12,0,2,7,'C',1,'K',7,0,0,'G',47,24,0,0,0,25,0,0,
0,255,14,1,2,1,24,0,0,0,25,1,0,0,1,24,0,1,0,25,1,1,0,1,24,0,3,
0,25,1,2,0,1,21,8,0,1,0,0,0,25,1,3,0,1,24,0,2,0,25,1,4,0,255,
14,1,1,21,8,0,0,0,0,0,25,1,3,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_25 [97] =
   {	// blr string 

4,2,4,1,2,0,7,0,7,0,4,0,2,0,41,3,0,32,0,41,3,0,32,0,12,0,2,7,
'C',1,'K',11,0,0,'G',58,47,24,0,0,0,25,0,1,0,47,24,0,2,0,25,0,
0,0,255,14,1,2,1,21,8,0,1,0,0,0,25,1,0,0,1,24,0,1,0,25,1,1,0,
255,14,1,1,21,8,0,0,0,0,0,25,1,0,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_32 [100] =
   {	// blr string 

4,2,4,1,4,0,41,3,0,32,0,7,0,7,0,7,0,4,0,1,0,41,3,0,32,0,12,0,
2,7,'C',1,'K',12,0,0,'G',47,24,0,0,0,25,0,0,0,255,14,1,2,1,24,
0,1,0,41,1,0,0,2,0,1,21,8,0,1,0,0,0,25,1,1,0,1,24,0,3,0,25,1,
3,0,255,14,1,1,21,8,0,0,0,0,0,25,1,1,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_40 [309] =
   {	// blr string 

4,2,4,1,24,0,9,0,41,3,0,32,0,41,3,0,32,0,7,0,7,0,7,0,7,0,7,0,
7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,
0,4,0,1,0,41,3,0,32,0,12,0,2,7,'C',2,'K',2,0,0,'K',5,0,1,'G',
58,47,24,0,0,0,24,1,2,0,47,24,1,1,0,25,0,0,0,'F',1,'H',24,1,6,
0,255,14,1,2,1,24,0,4,0,41,1,0,0,18,0,1,24,1,2,0,25,1,1,0,1,24,
1,0,0,25,1,2,0,1,21,8,0,1,0,0,0,25,1,3,0,1,24,0,15,0,25,1,4,0,
1,24,1,13,0,25,1,5,0,1,24,0,23,0,25,1,6,0,1,24,1,16,0,25,1,7,
0,1,24,0,25,0,41,1,9,0,8,0,1,24,1,18,0,41,1,11,0,10,0,1,24,0,
26,0,41,1,13,0,12,0,1,24,0,22,0,41,1,15,0,14,0,1,24,0,17,0,25,
1,16,0,1,24,0,10,0,25,1,17,0,1,24,0,11,0,25,1,19,0,1,24,0,9,0,
25,1,20,0,1,24,0,8,0,25,1,21,0,1,24,1,9,0,41,1,23,0,22,0,255,
14,1,1,21,8,0,0,0,0,0,25,1,3,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_68 [144] =
   {	// blr string 

4,2,4,1,9,0,41,0,0,0,1,9,0,41,3,0,32,0,7,0,7,0,7,0,7,0,7,0,7,
0,4,0,1,0,41,3,0,32,0,12,0,2,7,'C',1,'K',6,0,0,'G',47,24,0,8,
0,25,0,0,0,255,14,1,2,1,24,0,10,0,41,1,0,0,4,0,1,24,0,0,0,41,
1,1,0,5,0,1,24,0,13,0,25,1,2,0,1,21,8,0,1,0,0,0,25,1,3,0,1,24,
0,5,0,25,1,6,0,1,24,0,3,0,41,1,8,0,7,0,255,14,1,1,21,8,0,0,0,
0,0,25,1,3,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_81 [97] =
   {	// blr string 

4,2,4,1,1,0,7,0,4,0,1,0,41,3,0,32,0,12,0,2,7,'C',2,'K',6,0,0,
'K',5,0,1,'G',58,47,24,1,1,0,24,0,8,0,58,47,24,0,8,0,25,0,0,0,
57,61,24,0,3,0,61,24,1,9,0,255,14,1,2,1,21,8,0,1,0,0,0,25,1,0,
0,255,14,1,1,21,8,0,0,0,0,0,25,1,0,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_86 [104] =
   {	// blr string 

4,2,4,1,2,0,9,0,7,0,4,0,2,0,41,3,0,32,0,41,3,0,32,0,12,0,2,7,
'C',1,'K',27,0,0,'G',58,47,24,0,1,0,25,0,1,0,58,47,24,0,0,0,25,
0,0,0,59,61,24,0,5,0,255,14,1,2,1,24,0,5,0,25,1,0,0,1,21,8,0,
1,0,0,0,25,1,1,0,255,14,1,1,21,8,0,0,0,0,0,25,1,1,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_93 [146] =
   {	// blr string 

4,2,4,1,9,0,9,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,4,0,2,0,41,3,
0,32,0,41,3,0,32,0,12,0,2,7,'C',1,'K',27,0,0,'G',58,47,24,0,1,
0,25,0,1,0,47,24,0,0,0,25,0,0,0,255,14,1,2,1,24,0,7,0,41,1,0,
0,6,0,1,21,8,0,1,0,0,0,25,1,1,0,1,24,0,11,0,41,1,3,0,2,0,1,24,
0,10,0,41,1,5,0,4,0,1,24,0,9,0,41,1,8,0,7,0,255,14,1,1,21,8,0,
0,0,0,0,25,1,1,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_107 [318] =
   {	// blr string 

4,2,4,1,22,0,9,0,41,3,0,32,0,41,3,0,32,0,41,3,0,32,0,41,3,0,32,
0,41,3,0,32,0,41,3,0,32,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,
7,0,7,0,7,0,7,0,7,0,7,0,4,0,2,0,41,3,0,32,0,7,0,12,0,2,7,'C',
2,'K',27,0,0,'K',2,0,1,'G',58,47,24,1,0,0,24,0,4,0,58,47,24,0,
1,0,25,0,0,0,47,24,0,3,0,25,0,1,0,'F',1,'I',24,0,2,0,255,14,1,
2,1,24,1,6,0,41,1,0,0,8,0,1,24,1,0,0,25,1,1,0,1,24,0,13,0,41,
1,2,0,9,0,1,24,0,12,0,41,1,3,0,10,0,1,24,0,4,0,25,1,4,0,1,24,
0,0,0,25,1,5,0,1,24,0,1,0,25,1,6,0,1,21,8,0,1,0,0,0,25,1,7,0,
1,24,1,17,0,25,1,11,0,1,24,1,23,0,25,1,12,0,1,24,1,10,0,25,1,
13,0,1,24,1,25,0,41,1,15,0,14,0,1,24,1,26,0,41,1,17,0,16,0,1,
24,1,11,0,25,1,18,0,1,24,1,9,0,25,1,19,0,1,24,1,8,0,25,1,20,0,
1,24,0,2,0,25,1,21,0,255,14,1,1,21,8,0,0,0,0,0,25,1,7,0,255,255,
76
   };	// end of blr string 
static const UCHAR	jrd_134 [96] =
   {	// blr string 

4,2,4,1,3,0,41,3,0,32,0,7,0,7,0,4,0,1,0,41,3,0,32,0,12,0,2,7,
'C',1,'K',26,0,0,'G',47,24,0,0,0,25,0,0,0,255,14,1,2,1,24,0,8,
0,25,1,0,0,1,21,8,0,1,0,0,0,25,1,1,0,1,24,0,1,0,25,1,2,0,255,
14,1,1,21,8,0,0,0,0,0,25,1,1,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_141 [141] =
   {	// blr string 

4,2,4,1,2,0,41,3,0,32,0,7,0,4,0,1,0,41,3,0,32,0,12,0,2,7,'C',
3,'K',4,0,0,'K',3,0,1,'K',22,0,2,'G',58,58,47,24,1,0,0,24,0,0,
0,47,24,2,5,0,24,1,0,0,58,47,24,2,2,0,25,0,0,0,47,24,2,1,0,21,
14,11,0,'P','R','I','M','A','R','Y',32,'K','E','Y','F',1,'H',
24,1,2,0,255,14,1,2,1,24,1,1,0,25,1,0,0,1,21,8,0,1,0,0,0,25,1,
1,0,255,14,1,1,21,8,0,0,0,0,0,25,1,1,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_147 [163] =
   {	// blr string 

4,2,4,1,10,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,4,0,1,0,
41,3,0,32,0,12,0,2,7,'C',1,'K',15,0,0,'G',47,24,0,0,0,25,0,0,
0,'F',1,'H',24,0,1,0,255,14,1,2,1,21,8,0,1,0,0,0,25,1,0,0,1,24,
0,2,0,25,1,1,0,1,24,0,7,0,41,1,3,0,2,0,1,24,0,5,0,25,1,4,0,1,
24,0,6,0,41,1,6,0,5,0,1,24,0,4,0,25,1,7,0,1,24,0,3,0,25,1,8,0,
1,24,0,1,0,25,1,9,0,255,14,1,1,21,8,0,0,0,0,0,25,1,0,0,255,255,
76
   };	// end of blr string 
static const UCHAR	jrd_161 [82] =
   {	// blr string 

4,2,4,1,2,0,7,0,7,0,4,0,1,0,41,3,0,32,0,12,0,2,7,'C',1,'K',14,
0,0,'G',47,24,0,0,0,25,0,0,0,255,14,1,2,1,21,8,0,1,0,0,0,25,1,
0,0,1,24,0,6,0,25,1,1,0,255,14,1,1,21,8,0,0,0,0,0,25,1,0,0,255,
255,76
   };	// end of blr string 
...
static const UCHAR	jrd_172 [86] =
   {	// blr string 

4,2,4,1,3,0,9,0,7,0,7,0,4,0,1,0,41,3,0,32,0,12,0,2,7,'C',1,'K',
2,0,0,'G',47,24,0,0,0,25,0,0,0,255,14,1,2,1,24,0,6,0,41,1,0,0,
2,0,1,21,8,0,1,0,0,0,25,1,1,0,255,14,1,1,21,8,0,0,0,0,0,25,1,
1,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_179 [212] =
   {	// blr string 

4,2,4,1,17,0,9,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,
7,0,7,0,7,0,7,0,7,0,4,0,1,0,41,3,0,32,0,12,0,2,7,'C',1,'K',2,
0,0,'G',47,24,0,0,0,25,0,0,0,255,14,1,2,1,24,0,4,0,41,1,0,0,5,
0,1,21,8,0,1,0,0,0,25,1,1,0,1,24,0,17,0,25,1,2,0,1,24,0,10,0,
25,1,3,0,1,24,0,15,0,25,1,4,0,1,24,0,24,0,41,1,7,0,6,0,1,24,0,
25,0,41,1,9,0,8,0,1,24,0,26,0,41,1,11,0,10,0,1,24,0,22,0,41,1,
13,0,12,0,1,24,0,11,0,25,1,14,0,1,24,0,9,0,25,1,15,0,1,24,0,8,
0,25,1,16,0,255,14,1,1,21,8,0,0,0,0,0,25,1,1,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_200 [79] =
   {	// blr string 

4,2,4,0,2,0,41,3,0,32,0,7,0,2,7,'C',1,'K',1,0,0,'D',21,8,0,1,
0,0,0,'G',59,61,24,0,3,0,255,14,0,2,1,24,0,3,0,25,0,0,0,1,21,
8,0,1,0,0,0,25,0,1,0,255,14,0,1,21,8,0,0,0,0,0,25,0,1,0,255,255,
76
   };	// end of blr string 
static const UCHAR	jrd_204 [82] =
   {	// blr string 
...
static const UCHAR	jrd_210 [178] =
   {	// blr string 

4,2,4,1,5,0,7,0,7,0,7,0,7,0,7,0,4,0,1,0,41,3,0,32,0,12,0,2,7,
'C',3,'K',29,0,0,'K',28,0,1,'K',11,0,2,'G',58,47,24,1,4,0,24,
0,2,0,58,47,24,2,1,0,24,1,4,0,58,47,24,2,2,0,25,0,0,0,58,47,24,
2,0,0,21,14,22,0,'R','D','B','$','C','H','A','R','A','C','T',
'E','R','_','S','E','T','_','N','A','M','E',47,24,1,3,0,24,0,
0,0,255,14,1,2,1,21,8,0,1,0,0,0,25,1,0,0,1,24,1,8,0,41,1,2,0,
1,0,1,24,0,1,0,25,1,3,0,1,24,0,2,0,25,1,4,0,255,14,1,1,21,8,0,
0,0,0,0,25,1,0,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_219 [130] =
   {	// blr string 

4,2,4,1,5,0,9,0,9,0,7,0,7,0,7,0,4,0,2,0,41,3,0,32,0,41,3,0,32,
0,12,0,2,7,'C',2,'K',5,0,0,'K',2,0,1,'G',58,47,24,0,1,0,25,0,
1,0,58,47,24,0,2,0,24,1,0,0,47,24,0,0,0,25,0,0,0,255,14,1,2,1,
24,1,6,0,41,1,0,0,3,0,1,24,0,12,0,41,1,1,0,4,0,1,21,8,0,1,0,0,
0,25,1,2,0,255,14,1,1,21,8,0,0,0,0,0,25,1,2,0,255,255,76
   };	// end of blr string 
static const UCHAR	jrd_229 [134] =
   {	// blr string 

4,2,4,1,5,0,7,0,7,0,7,0,7,0,7,0,4,0,2,0,41,3,0,32,0,7,0,12,0,
2,7,'C',2,'K',29,0,0,'K',28,0,1,'G',58,47,24,1,4,0,24,0,2,0,58,
47,24,0,0,0,25,0,0,0,47,24,0,2,0,25,0,1,0,255,14,1,2,1,21,8,0,
1,0,0,0,25,1,0,0,1,24,1,8,0,41,1,2,0,1,0,1,24,0,1,0,25,1,3,0,
1,24,0,2,0,25,1,4,0,255,14,1,1,21,8,0,0,0,0,0,25,1,0,0,255,255,
76
   };	// end of blr string 
