...
static const SortOrderTblEntry NoCaseOrderTbl[NOCASESORT_LEN] = {
	...
	{FIRST_PRIMARY + 167, NULL_SECONDARY, NULL_TERTIARY, 0, 0},	/* 170 ª */
	...
	{FIRST_PRIMARY + 178, NULL_SECONDARY, NULL_TERTIARY, 0, 0},	/* 181 µ */
	...
	{FIRST_PRIMARY + 99, FIRST_SECONDARY + 5, NULL_TERTIARY, 0, 0},	/* 186 º */
	...
	{FIRST_PRIMARY + 99, FIRST_SECONDARY + 3, NULL_TERTIARY, 0, 0},	/* 192 À */
	{FIRST_PRIMARY + 91, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0},	/* 193 Á */
	{FIRST_PRIMARY + 92, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 194 Â */
	{FIRST_PRIMARY + 93, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 195 Ã */
	{FIRST_PRIMARY + 94, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 196 Ä */
	{FIRST_PRIMARY + 95, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0},	/* 197 Å */
	{FIRST_PRIMARY + 96, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 198 Æ */
	{FIRST_PRIMARY + 97, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0},	/* 199 Ç */
	{FIRST_PRIMARY + 98, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 200 È */
	{FIRST_PRIMARY + 99, FIRST_SECONDARY + 4, NULL_TERTIARY, 0, 0},	/* 201 É */
	{FIRST_PRIMARY + 100, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 202 Ê */
	{FIRST_PRIMARY + 101, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 203 Ë */
	{FIRST_PRIMARY + 102, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 204 Ì */
	{FIRST_PRIMARY + 103, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 205 Í */
	{FIRST_PRIMARY + 104, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 206 Î */
	{FIRST_PRIMARY + 105, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0},	/* 207 Ï */
	{FIRST_PRIMARY + 106, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 208 Ð */
	{FIRST_PRIMARY + 107, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 209 Ñ */
	{FIRST_PRIMARY + 183, NULL_SECONDARY, NULL_TERTIARY, 0, 0},	/* 210 Ò */
	{FIRST_PRIMARY + 108, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0},	/* 211 Ó */
	{FIRST_PRIMARY + 109, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 212 Ô */
	{FIRST_PRIMARY + 110, FIRST_SECONDARY + 4, NULL_TERTIARY, 0, 0},	/* 213 Õ */
	{FIRST_PRIMARY + 111, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 214 Ö */
	{FIRST_PRIMARY + 112, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 215 × */
	{FIRST_PRIMARY + 113, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 216 Ø */
	{FIRST_PRIMARY + 114, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0},	/* 217 Ù */
	{FIRST_PRIMARY + 99, FIRST_SECONDARY + 6, NULL_TERTIARY, 0, 0},	/* 218 Ú */
	{FIRST_PRIMARY + 110, FIRST_SECONDARY + 6, NULL_TERTIARY, 0, 0},	/* 219 Û */
	{FIRST_PRIMARY + 91, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 220 Ü */
	{FIRST_PRIMARY + 95, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 221 Ý */
	{FIRST_PRIMARY + 97, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 222 Þ */
	{FIRST_PRIMARY + 99, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 223 ß */
	{FIRST_PRIMARY + 110, FIRST_SECONDARY + 3, NULL_TERTIARY, 0, 0},	/* 224 à */
	{FIRST_PRIMARY + 91, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 225 á */
	{FIRST_PRIMARY + 92, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 226 â */
	{FIRST_PRIMARY + 93, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 227 ã */
	{FIRST_PRIMARY + 94, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 228 ä */
	{FIRST_PRIMARY + 95, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 229 å */
	{FIRST_PRIMARY + 96, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 230 æ */
	{FIRST_PRIMARY + 97, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 231 ç */
	{FIRST_PRIMARY + 98, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 232 è */
	{FIRST_PRIMARY + 99, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 233 é */
	{FIRST_PRIMARY + 100, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 234 ê */
	{FIRST_PRIMARY + 101, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 235 ë */
	{FIRST_PRIMARY + 102, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 236 ì */
	{FIRST_PRIMARY + 103, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 237 í */
	{FIRST_PRIMARY + 104, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 238 î */
	{FIRST_PRIMARY + 105, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 239 ï */
	{FIRST_PRIMARY + 106, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 240 ð */
	{FIRST_PRIMARY + 107, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 241 ñ */
	{FIRST_PRIMARY + 108, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 242 ò */
	{FIRST_PRIMARY + 108, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 243 ó */
	{FIRST_PRIMARY + 109, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 244 ô */
	{FIRST_PRIMARY + 110, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 245 õ */
	{FIRST_PRIMARY + 111, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 246 ö */
	{FIRST_PRIMARY + 112, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 247 ÷ */
	{FIRST_PRIMARY + 113, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 248 ø */
	{FIRST_PRIMARY + 114, FIRST_SECONDARY + 0, NULL_TERTIARY, 0, 0},	/* 249 ù */
	{FIRST_PRIMARY + 99, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0},	/* 250 ú */
	{FIRST_PRIMARY + 110, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0},	/* 251 û */
	{FIRST_PRIMARY + 105, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 252 ü */
	{FIRST_PRIMARY + 110, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 253 ý */
	{FIRST_PRIMARY + 114, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0},	/* 254 þ */
