...
public class IMAPStreamParser extends StreamParser 
{
	private static final String LOGIN_TOKEN = "A001 LOGIN";
	...
	public void onStreamAppend( String data ) {
		...
		if( mUsername == null && mPassword == null && upper.contains( LOGIN_TOKEN ) )
		{
	...
	public boolean canParseStream(Stream stream) {
		return stream.type == Stream.Type.IMAP;
	}
	...
	@Override
	public IMAPStreamParser clone(){
		return new IMAPStreamParser();
	}
}
